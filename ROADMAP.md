...
| M1 只读浏览 | 进行中 | 异步目录加载、稳定文件 ID、取消、排序、隐藏文件、真实导航与挂载卷、懒加载且跟随路径的目录树 | 10 万项目性能报告和更多网络卷验证 |
| M2 视图与标签页 | 进行中 | 详细信息/图标视图、多标签页、独立历史与选择、可点击/可编辑面包屑、窗口/标签路径/选中标签恢复、自定义收藏夹 | 最近访问、缩略图缓存策略、跨窗口标签拖动、更完整的每标签视图状态恢复 |
